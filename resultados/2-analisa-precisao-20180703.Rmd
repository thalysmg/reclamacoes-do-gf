...
reclamacoesFiltradas = reclamacoes_l %>% select(ID = id, Polaridade = polaridade, Polaridade_Normalizada = polaridade_normalizada, 
                                                Comprimento = comprimento_reclamacao, Palavras = palavras, Lexico = lexico, Erro = erro)
```
